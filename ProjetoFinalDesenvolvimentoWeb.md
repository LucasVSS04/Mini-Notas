...
Trocar `document.body.classList` (curso) por `document.documentElement.setAttribute(
'data-bs-theme', ...)` é o que conecta o nosso toggle ao dark mode do Bootstrap. Nenhuma
